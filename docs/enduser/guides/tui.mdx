...
<Frame caption="TUI dashboard — worker health, alerts, model status">
  <img src="/docs/images/tui/dashboard.png" alt="HOOX TUI dashboard view" />
</Frame>

<Frame caption="Stitched tour of primary TUI views">
  <img src="/docs/images/gifs/tui-view-switch.gif" alt="GIF of HOOX TUI views" />
</Frame>

Still of every view and wizard step: [Interface gallery](/docs/enduser/guides/screenshots).
...
export HOOX_API_TOKEN=…   # or Access service-token env
...
# 6. Repo-root shortcut (from a cloned monorepo)
./hoox-tui
```
...
- **[Local Development](/docs/enduser/guides/local-development)** — API / wrangler mesh that feeds the TUI  
- **[CLI Reference](/docs/enduser/reference/cli-commands)** — commands the TUI invokes  
- **[TUI architecture (DevOps)](/docs/devops/tui)** — stores, backoff, crash model  
